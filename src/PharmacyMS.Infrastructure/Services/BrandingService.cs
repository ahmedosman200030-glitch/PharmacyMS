...
public class BrandingService : IBrandingService
{
    ...
    public async Task SavePharmacyInfoAsync(string? pharmacyName, string? address, string? phoneNumber, string? mobileNumber, string? email, string? website)
    {
        using var conn = _context.CreateConnection();

        var pairs = new (string Key, string? Value)[]
        {
            (PharmacyNameKey, pharmacyName),
            (AddressKey, address),
